...
public class MyUser {
	...
	private Set<SavingsInvestments> savingsInvestments = new HashSet<>();

	public Set<SavingsInvestments> getSavingsInvestments() {
	    return savingsInvestments;
	}

	public void setSavingsInvestments(Set<SavingsInvestments> savingsInvestments) {
