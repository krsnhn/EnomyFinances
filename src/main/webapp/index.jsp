...
.landing-page .content .info .explore-button {
  border: 0;
  border-radius: 20px;
  padding: 12px 30px;
  margin-top: 30px;
  ...
  display: inline-block; /* Added to make the button behave like an inline element */
}

.landing-page .content .info .explore-button:hover {
  background-color: #005482; /* Change the hover background color if needed */
}
        ...
        <div class="content">
          <div class="container">
            <div class="info">
              ...
              <button class="explore-button"><a href="signup">Explore Now</a></button>
          </div>
        </div>
      </div>
      </div>
